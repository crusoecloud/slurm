...
grafana_admin_password = "<make up a secure password for the Grafana dashboard>"
...
partitions = [
    {
      name = "h200partition"
      count = 64
      type = "h200-141gb-sxm-ib.8x"
      imex_support = false
      ib_partition_id = "<your H200 IB partition ID"
      image = "ubuntu24.04-nvidia-slurm"
      custom_image = null
      reservation_id = null
      extra_args = {
        "Default" = "YES",
